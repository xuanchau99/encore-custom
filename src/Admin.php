...
class Admin
{
    ...
    public function getFullName()
    {
        ...
        $iDRelPerson = $this->guard()->user()->IDRelPerson;
        if ($iDRelPerson) {
            $Person = DB::table('rel_person')->where('IDRelPerson', $iDRelPerson)->get()->toArray();
            $fullName = $Person[0]->FirstName.' '.$Person[0]->MiddleName.' '.$Person[0]->LastName;
        }
        else {

...
class Actions extends AbstractDisplayer
{
    ...
    {
        $title = __('crud.show_detail_item');
        return <<<EOT
<a href="{$this->getResource()}/{$this->getRouteKey()}" class="{$this->grid->getGridRowName()}-view" alt="$title" title="$title">
    <i class="fa fa-eye"></i>
</a>
EOT;
    }
    ...
    {
        $title = __('crud.edit_item');
        return <<<EOT
<a href="{$this->getResource()}/{$this->getRouteKey()}/edit" class="{$this->grid->getGridRowName()}-edit" alt="$title" title="$title">
...
EOT;
    ...
    {
        $title = __('crud.delete_item');
        $this->setupDeleteScript();

        return <<<EOT
<a href="javascript:void(0);" data-id="{$this->getKey()}" class="{$this->grid->getGridRowName()}-delete" alt="$title" title="$title">
